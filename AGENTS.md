...
Guidance for AI coding agents working in **linkat-directory**.
...
Sync AGENTS.md from zincfox; Sync AGENTS.md from zincfox; Sync CONTRIBUTING.md from zincfox; Sync CONTRIBUTING.md from zincfox; fix: use static public environment for prerendering (#1)